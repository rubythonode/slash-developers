...
name: Images
title: Images
metainformation: 'Contentful has a separate Images API that helps you add and retrieve image files in spaces, but also offers manipulation features to make images look how you want.'
slug: null
tags: null
nextsteps: null
---
